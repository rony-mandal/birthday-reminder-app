...
const AddBirthdayModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(`${formData.name}'s birthday added!`);
      setFormData({
        name: "",
        birth_date: "",
        relation: "",
      ...
      <DialogContent className="neo-card border-2 border-black max-w-md mx-auto p-0 overflow-hidden">
        <DialogHeader className="p-6 pb-0">
          <DialogTitle className="font-heading text-2xl font-black flex items-center gap-2">
            <span className="text-3xl">🎂</span> ADD BIRTHDAY
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="p-6 pt-4 space-y-4">
          ...
          <div>
            ...
            >
              <SelectTrigger className="neo-input w-full" data-testid="birthday-relation-select">
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              ...
              data-testid="submit-birthday-btn"
            >
